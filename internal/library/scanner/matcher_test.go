...
func TestMatcher3(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Nekomonogatari Notflix",
			paths: []string{
				"E:/Anime/Monogatari Series/Nekomonogatari (Notflix)/[Commie] Nekomonogatari (Notflix) - 01 [B085F6CB].mkv",
				"E:/Anime/Monogatari Series/Nekomonogatari (Notflix)/[Coalgirls]_Nekomonogatari_(Notflix)_02_(1920x1080_Blu-ray_FLAC)_[A38F72D0].mkv",
				"E:/Anime/Monogatari Series/Nekomonogatari (Notflix)/[MTBB] Nekomonogatari: Notflix - 03 (1080p BD) [5C0A0065].mkv",
			},
