...
// the rest of seanime, scoped under its own tables to make this Notflix-specific
...
type NotflixProfileListEntry struct {
	BaseModel
	ProfileUID string `gorm:"column:profile_uid;size:64;not null;uniqueIndex:idx_notflix_profile_list,priority:1" json:"profileUid"`
	MediaID    int    `gorm:"column:media_id;not null;uniqueIndex:idx_notflix_profile_list,priority:2" json:"mediaId"`
...
type NotflixProfileWatchHistory struct {
	BaseModel
	...
	ProfileUID    string  `gorm:"column:profile_uid;size:64;not null;uniqueIndex:idx_notflix_profile_media_episode,priority:1" json:"profileUid"`
	MediaID       int     `gorm:"column:media_id;not null;index;uniqueIndex:idx_notflix_profile_media_episode,priority:2" json:"mediaId"`
	EpisodeNumber int     `gorm:"column:episode_number;not null;uniqueIndex:idx_notflix_profile_media_episode,priority:3" json:"episodeNumber"`
