    ...
    return (
        ...
        >
            ...
            <div className="absolute top-3 right-3 grid grid-cols-2 gap-1 p-1 rounded-[--radius-md] bg-gray-900 z-[2]">
                ...
                >
                    <p>
                        Notflix failed to load this extension. If you aren't sure what this means, please contact the author.
                    </p>
                    <p>
            ...
            <div className="z-[1] relative space-y-3">
                ...
                <div>
                    <p className="text-red-400 text-sm">
                        ...
                        {extension.code === "invalid_semver_constraint" && "Incompatible with this version of Notflix"}
            ...
            <div className="absolute top-3 right-3 flex flex-col gap-1 p-1 rounded-xl bg-gray-900 z-[2]">
                ...
                >
                    ...
                    {isUnsafe && <Alert
                        ...
                        description="This plugin relies on unsafe flags to function. Notflix cannot guarantee that it is safe to use."
                        // className="mb-4"
                    />}
