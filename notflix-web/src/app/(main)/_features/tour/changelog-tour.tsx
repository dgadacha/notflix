    ...
    const get3_5_0 = (): TourStep[] => {
        return [
            ...
            },
            {
                ...
                content: "Transcoding/Direct Play now uses the custom Notflix player used by Notflix Denshi and Online Streaming.",
                route: "/settings",
                prepare: async () => {
    ...
    const get3_7_0 = (): TourStep[] => {
        return [
            ...
            },
            {
                id: "changelog-2",
                title: "Bug Fixes",
                content: "Several bugs have been fixed in this release, including some related to Notflix Denshi and plugins. Read the full changelog for more details.",
                route: "/",
                ignoreOutsideClick: true,
            },
        ]
