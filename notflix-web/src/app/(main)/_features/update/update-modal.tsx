            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    {serverStatus?.isDesktopSidecar && <Alert
                        intent="info"
                        description="Update Notflix from the desktop application."
                    />}
                    ...
                    <div className="flex gap-2 w-full items-center !mt-4">
                        {!serverStatus?.isDesktopSidecar && <Modal
                            ...
                            title={<span>Update Notflix</span>}
                        >
                            <div className="space-y-4">
                                <p>
                                    Notflix will perform an update by downloading and replacing existing files.
