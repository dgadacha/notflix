...
const generateBridgeScript = (token: string, parentOrigin: string, widgetId: string) => `
    ...
    window.webview = {
        ...
        // Notify Notflix when the webview body changed size
        _onResizeObserved: () => {
    ...
    // Notify Notflix to resize iframe when content changes
