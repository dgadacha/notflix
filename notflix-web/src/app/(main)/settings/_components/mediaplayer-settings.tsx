    ...
    return (
        <>
            <SettingsPageHeader
                ...
                description="Notflix has built-in support for MPV, VLC, IINA, and MPC-HC."
                icon={LuMonitorPlay}
            />
            ...
            <SettingsCard>
                ...
                {selectedPlayer === "iina" && <Alert
                    intent="info-basic"
                    description={<p>For IINA to work correctly with Notflix, make sure <strong>Quit after all windows are closed</strong> is <span
                        className="underline"
            ...
            <SettingsCard title="Playback">
                <Field.Switch
                    ...
                    help="If enabled, Notflix will play the next episode after a delay when the current episode is completed."
                />
            </SettingsCard>
