...
export function UISettings() {
    ...
    function handleSave(data: z.infer<typeof themeSchema>) {
        if (colord(data.backgroundColor).isLight()) {
            toast.error("Notflix does not support light themes")
            return
        }
            ...
            {(f) => (
                <>
                    ...
                    >
                        ...
                        {/*            help="Notflix will try to fix border rendering artifacts. This setting only affects this client/browser."*/}
