        ...
        <>
            <SettingsCard title="Rich Presence" description="Show what you are watching or reading in Discord.">
                ...
                <Field.Switch
                    ...
                    label="Hide Notflix Repository Button"
                />
                ...
                {/*    help="Replace 'Notflix' with the media title in the activity status. Only works if you use a discord client that utilizes arRPC."*/}
                {/*/>*/}
            </SettingsCard>
        </>
    )
