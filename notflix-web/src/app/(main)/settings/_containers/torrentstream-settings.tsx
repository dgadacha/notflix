                    ...
                    <>
                        ...
                        <SettingsCard title="Auto-select">
                            <Field.Switch
                                ...
                                name="autoSelect"
                                label="Enable"
                                help="Let Notflix find the best torrent automatically."
                            />

                            <Field.Select
                                name="preferredResolution"
                                label="Preferred resolution"
                                help="If auto-select is enabled, Notflix will try to find torrents with this resolution."
                                options={[
                                    { label: "Highest", value: "-" },
                        ...
                        {/* <SettingsCard title="Torrent Client" description="Notflix uses a built-in torrent client to download torrents.">
