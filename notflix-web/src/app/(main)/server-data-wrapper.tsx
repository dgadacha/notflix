    ...
    if (currentServerStatus.updating) {
        return <div className="container max-w-3xl py-10">
            <div className="mb-4 flex justify-center w-full">
                <img src="/notflix-logo.svg" alt="logo" className="w-14 h-auto" />
            </div>
            <p className="text-center text-lg">
                Notflix is currently updating. Refresh the page once the update is complete and the connection has been reestablished.
            </p>
        </div>
    }
            ...
            <Card className="md:py-10">
                <AppLayoutStack>
                    <div className="text-center space-y-4">
                        <div className="mb-4 flex justify-center w-full">
                            <img src="/notflix-logo.svg" alt="logo" className="w-24 h-auto" />
                        </div>
                        <h3>Welcome!</h3>
                        <Button
                            onClick={() => {
