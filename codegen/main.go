...
import (
	"flag"
	codegen "notflix/codegen/internal"
)
...
func main() {
	...
	if !skipTypes {
		goStructStrs := codegen.GenerateTypescriptEndpointsFile("./generated/handlers.json", "./generated/public_structs.json", "../notflix-web/src/api/generated", "../internal/events")
		codegen.GenerateTypescriptFile("./generated/handlers.json", "./generated/public_structs.json", "../notflix-web/src/api/generated", goStructStrs)
	}
	...
	if !skipPluginEvents {
		codegen.GeneratePluginEventFile("../internal/plugin/ui/events.go", "../notflix-web/src/app/(main)/_features/plugin/generated")
	}
